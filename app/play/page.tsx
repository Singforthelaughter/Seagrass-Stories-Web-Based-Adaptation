  ...
  return (
    <main className="relative h-full w-full overflow-hidden bg-[#04161f]">
      ...
      <Link
        href="/"
        aria-label="Surface"
        onClick={() => setPhase("personalise")}
        className="absolute left-4 top-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/30 text-[#cfeaf2] backdrop-blur transition active:scale-95"
      >
